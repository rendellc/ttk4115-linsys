...
sizes.DirFeedthrough = 0; % 1 if the input is needed directly in the update part
sizes.NumSampleTimes = 1; % Do not modify  

sys = simsizes(sizes); % Do not modify  

x0  = data.xk_minus; % Initial values for the discrete states, modify
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Kk = data.Pk_minus * data.C'*inv(data.C*data.Pk_minus*data.C' + data.Rd);
...
x = data.xk_minus + Kk*(y - data.C*data.xk_minus);


sys=data.Ad*x+data.Bd*u;
